...
2. Navigate to Dashboard → Submit Claim
...
4. The total amount will be auto-calculated
5. Click "Submit Claim" (button enables only when validation passes)

### Approving Claims (Coordinator/Manager)

1. Log in with coordinator or manager account
2. Navigate to Dashboard → View Claims
3. Use DataTables features to filter/search/sort claims
4. For individual actions:
